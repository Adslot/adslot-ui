  ...
  injectProps(children) {
    return React.Children.map(children, child => {
      if ( /*#__PURE__*/React.isValidElement(child)) {
        ...
        const childNodes = React.Children.map(child.props.children, childNode => /*#__PURE__*/React.isValidElement(childNode) ? /*#__PURE__*/React.cloneElement(childNode, { ...childNode.props,
