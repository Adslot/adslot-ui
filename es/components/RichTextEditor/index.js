...
const editorStateFromHTML = (input, options = {}) => EditorState.createWithContent(stateFromHTML(input, {
...
const RichTextEditor = ({
  ...
  invariant(!(value && !onChange), 'Failed prop type: You have provided a `value` prop to RichTextEditor component without an `onChange` handler. This will render a read-only field.');
