...
var BLOCK_TYPES = [{
  label: /*#__PURE__*/React.createElement(BulletIcon, null),
  style: 'unordered-list-item'
}, {
  label: /*#__PURE__*/React.createElement(NumberIcon, null),
  style: 'ordered-list-item'
}];

var BlockStyleButtons = function BlockStyleButtons(props) {
  ...
  return BLOCK_TYPES.map(function (type) {
