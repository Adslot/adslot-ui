...
const Anchor = props => {
  ...
  const isLink = variant === 'link' || (className === null || className === void 0 ? void 0 : (_className$match = className.match(/\b(btn-link)\b/)) === null || _className$match === void 0 ? void 0 : _className$match[0]);
