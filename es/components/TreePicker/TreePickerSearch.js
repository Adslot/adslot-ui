...
import { useTreePickerGetState, useInternalActions, useTreePickerSearch, useTreePickerSlice } from './TreePickerContext';
...
const TreePickerSearch = ({
  ...
  return /*#__PURE__*/React.createElement(Search, Object.assign({}, rest, {
    ref: inputRef,
    disabled: isDisabled,
