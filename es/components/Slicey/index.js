...
var getArcElements = function getArcElements(filteredDataset) {
  ...
  return /*#__PURE__*/React.createElement("circle", {
    className: "arc-component ".concat(_.kebabCase(filteredDataset[0].label)),
    r: ".5",
    cx: "0",
    cy: "0"
  });
...
var Slicey = function Slicey(_ref2) {
  ...
  var donutEl = donut ? /*#__PURE__*/React.createElement(Donut, null) : null;
  var markerEl = marker ? /*#__PURE__*/React.createElement(Marker, {
    fraction: marker
  }) : null;
