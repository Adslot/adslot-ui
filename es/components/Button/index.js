...
const Button = props => {
  ...
  const isLink = variant === 'link' || (className === null || className === void 0 ? void 0 : (_className$match = className.match(/\b(aui-link)\b/)) === null || _className$match === void 0 ? void 0 : _className$match[0]); // eslint-disable-next-line react/prop-types
