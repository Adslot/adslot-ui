...
class TreePickerNode extends React.PureComponent {
  ...
  componentDidMount() {
    invariant(!(_.isUndefined(this.props.node.path) && _.isUndefined(this.props.node.ancestors)), `TreePickerNode needs property 'path' or property 'ancestors' for ${this.props.node.id}`);
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      wrapper: children => /*#__PURE__*/React.createElement(Popover, {
        theme: "dark",
        placement: "top",
        trigger: "hover",
