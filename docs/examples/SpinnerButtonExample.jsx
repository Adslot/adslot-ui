...
class SpinnerButtonExample extends React.Component {
  ...
  render() {
    ...
    return (
      <SpinnerButton bsStyle="primary" isLoading={isLoading} onClick={onClick}>
        Save Details
      </SpinnerButton>
    );
  }
  ...
  propTypes: [
    {
      ...
      note: (
        <span>
          When <pre>isLoading</pre> is <pre>true</pre> the button is disabled.
        </span>
      ),
    },
    {
      ...
      note: (
        <span>
          Should set <pre>isLoading</pre> to true, and reset to <pre>false</pre> upon completion.
        </span>
      ),
    },
  ],
