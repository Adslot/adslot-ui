...
/>`,
  propTypes: [{
    ...
    note: <span>Slicey will represent all values as percentage of the pie based on the sum of all values.
    Label will provide a className to each slice as <pre>.arc-component-{'${label}'}</pre>.</span>,
  }, {
    propType: 'diameter',
    type: 'number',
    defaultValue: '100',
...
export default () => <Example {...exampleProps}><SliceyExample /></Example>;
