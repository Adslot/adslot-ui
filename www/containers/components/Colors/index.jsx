    ...
    <>
      <div className="token-container">
        ...
        <div className="token-group">
          ...
          <h4>In css:</h4>
          <pre>
            <code>{`@import url('adslot-ui/system/tokens/styles/tokens.css';)`}</code>
          </pre>

          <h4>In javascript:</h4>
          <pre>
            <code>{`import colorJSON from 'adslot-ui/system/tokens/color.json';

console.log(colorJSON.color.blue[500]);`}</code>
          </pre>
