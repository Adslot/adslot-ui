...
const Card = ({
  ...
  const nestedChildren = _react.default.Children.map(children, child => !_lodash.default.get(child, 'props.append') ? child : null);
  const appendedChildren = _react.default.Children.map(children, child => _lodash.default.get(child, 'props.append') ? child : null);
  return /*#__PURE__*/_react.default.createElement("div", Object.assign({
