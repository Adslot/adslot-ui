    ...
    value: function injectProps(children) {
      ...
      return _react.default.Children.map(children, function (child) {
        if ( /*#__PURE__*/_react.default.isValidElement(child)) {
          var buttonProps = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _this.props.theme ? {
            theme: _this.props.theme
          } : {}), !_lodash.default.isNil(_this.props.inverse) ? {
...
ButtonGroup.propTypes = {
   ...
   */
  theme: _propTypes.default.oneOf(['primary', 'success', 'info', 'warning', 'danger', 'link']),
