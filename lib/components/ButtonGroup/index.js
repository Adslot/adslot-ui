  ...
  injectProps(children) {
    return _react.default.Children.map(children, child => {
      if ( /*#__PURE__*/_react.default.isValidElement(child)) {
        ...
        const childNodes = _react.default.Children.map(child.props.children, childNode => /*#__PURE__*/_react.default.isValidElement(childNode) ? /*#__PURE__*/_react.default.cloneElement(childNode, {
          ...childNode.props,
