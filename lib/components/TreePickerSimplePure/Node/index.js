...
const pathPrefix = ({
  type
}) => _lodash.default.isEmpty(type) ? '' : `${type} in `;
...
class TreePickerNode extends _react.default.PureComponent {
  ...
  componentDidMount() {
    (0, _invariant.default)(!(_lodash.default.isUndefined(this.props.node.path) && _lodash.default.isUndefined(this.props.node.ancestors)), `TreePickerNode needs property 'path' or property 'ancestors' for ${this.props.node.id}`);
  }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      condition: !isExpandable && !_lodash.default.isNil(node.unExpandableMessage),
      wrapper: children => /*#__PURE__*/_react.default.createElement(_Popover.default, {
        theme: "dark",
        placement: "top",
        trigger: "hover",
        popoverContent: node.unExpandableMessage
      }, children)
