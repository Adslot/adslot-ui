...
const TreePickerGrid = ({
  ...
  const nodesByGroupLabel = _lodash.default.groupBy(nodes, groupFormatter);
  ...
  return /*#__PURE__*/_react.default.createElement(_Grid.default, null, isLoading ? /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement(_Spinner.default, null), /*#__PURE__*/_react.default.createElement("p", null, "Loading\u2026")) : _lodash.default.map(nodesByGroupLabel, (groupedNodes, label) => /*#__PURE__*/_react.default.createElement("div", {
    ...
    dts: `group-label-${_lodash.default.kebabCase(label)}`
  }, label)) : null, _lodash.default.map(groupedNodes, node => /*#__PURE__*/_react.default.createElement(_Node.default, {
    key: node.id,
    disabled,
    expandNode,
    includeNode,
...
var _default = exports.default = TreePickerGrid;