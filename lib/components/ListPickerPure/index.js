...
var _useArrowFocus = _interopRequireDefault(require("../../hooks/useArrowFocus"));
const ListPickerPure = ({
  ...
  (0, _useArrowFocus.default)({
    ref,
    onFocus: el => !allowMultiSelection && handleChange(_lodash.default.find(items, ({
      id
    }) => _lodash.default.toString(id) === el.dataset.auiValue))(),
  ...
  const handleChange = item => {
    return () => {
      ...
      if (isSelected) {
        setSelectedItems(_selectedItems => allowMultiSelection ? _lodash.default.reject(_selectedItems, {
          id: item.id
        }) : [item]);
...
ListPickerPure.propTypes = {
  ...
  deselectItem: _propTypes.default.func.isRequired,
...
var _default = exports.default = ListPickerPure;