...
var Skeleton = function Skeleton(_ref) {
  ...
  var variantClass = function variantClass() {
    return _lodash.default.includes(['rect', 'circle', 'text'], variant) ? "".concat(baseClass, "-").concat(variant) : '';
  };

  return /*#__PURE__*/_react.default.createElement("span", Object.assign({
    className: (0, _classnames2.default)(baseClass, variantClass(), (0, _defineProperty2.default)({}, "".concat(baseClass, "-animated"), animated), className),
    style: {
      height: height,
      width: width
    }
