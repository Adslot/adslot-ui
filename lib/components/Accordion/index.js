...
const Accordion = ({
  ...
  (0, _invariant.default)(_lodash.default.isNumber(maxExpand) && maxExpand > 0 || _lodash.default.isString(maxExpand) && maxExpand === 'max', "maxExpand must be a positive number or 'max'");
