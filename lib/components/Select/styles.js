...
var borderColor = _system.color.gray.base;
var defaultStyle = {
  option: function option(styles, _ref) {
    ...
    switch (true) {
      case isSelected:
        backgroundColor = _system.color.gray.lighter;
        break;

      case isFocused:
        backgroundColor = _system.color.gray.lightest;
        break;
  ...
  multiValue: function multiValue(styles) {
    return _objectSpread(_objectSpread({}, styles), {}, {
      color: '#fff',
      backgroundColor: _system.color.gray.dark
    });
  },
