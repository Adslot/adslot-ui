...
const selectComponentBuilder = Component => {
  const SelectComponent = props => {
    ...
    const selectProps = { ..._lodash.default.omit(props, ['components', 'className', 'styles', 'isInModal']),
...
const Select = selectComponentBuilder(_reactSelect.default); // re-export components so user can customize various components
