...
const Checkbox = ({
  ...
  (0, _invariant.default)(!size, 'Checkbox size prop has been deprecated.');
  (0, _invariant.default)(!inline, 'Checkbox inline prop has been deprecated.');
  (0, _invariant.default)(!((icon || text) && variant !== 'box'), 'Checkbox with icon or text must use box variant.');
  const handleChange = () => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", Object.assign({}, rest, {
    ...
    className: "aui--checkbox-label-container",
    htmlFor: id
...
const shareCheckboxPropTypes = exports.shareCheckboxPropTypes = {
  /**
