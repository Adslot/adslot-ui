...
const useArrowFocus = _ref => {
  ...
  const getDOMList = _react.default.useCallback(() => {
    var _ref$current;

    return Array.from(((_ref$current = ref.current) === null || _ref$current === void 0 ? void 0 : _ref$current.querySelectorAll(selector)) ?? 0);
  }, [ref, selector]);
  ...
  const focusEl = function () {
    ...
    nextEl.focus();
    (_onFocusRef$current = onFocusRef.current) === null || _onFocusRef$current === void 0 ? void 0 : _onFocusRef$current.call(onFocusRef, nextEl);
  };
  ...
  _react.default.useEffect(() => {
    const focusNext = isForward => {
      ...
      if (nextEl && !getIsDisabled(nextEl)) {
        ...
        nextEl.focus();
        (_onFocusRef$current2 = onFocusRef.current) === null || _onFocusRef$current2 === void 0 ? void 0 : _onFocusRef$current2.call(onFocusRef, nextEl);
      }
    };
