...
it('should have its component name as default className and no data-test-selector', () => {
  ...
  expect(screen.getByTestId('grid-cell-wrapper')).toHaveTextContent('');
...
it('should apply data-test-selector', () => {
  ...
  expect(screen.getByTestId('grid-cell-wrapper')).toHaveAttribute('data-test-selector', 'this-has-data-test-selector');
});
