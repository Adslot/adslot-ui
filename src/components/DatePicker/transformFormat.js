...
const momentFormattingTokens =
  '[Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|N{1,5}|YYYYYY|YYYYY|YYYY|YY|y{2,4}|yo?|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?';

const momentFormattingTokensRegExp = new RegExp(
  `${momentEscapeToken}(${momentLocalFormatting}|${momentFormattingTokens}|.)`,
  'g'
);
...
const tokenMapping = {
  ...
  A: 'a', // AM PM
  // Time Zone
  Z: 'xxx', // -07:00 -06:00 ... +06:00 +07:00
  ZZ: 'xx', //  -0700 -0600 ... +0600 +0700
  // Era
  N: 'G', // BC AD
  NN: 'GG', // BC AD
  NNN: 'GGG', // BC AD
  NNNN: 'GGGG', // Before Christ, Anno Domini
  NNNNN: 'G', // BC AD
  yy: 'yyyy', // Era Year?
  // Week Year
  gg: 'YY', //  70 71 ... 29 30
  gggg: 'YYYY', // 70 71 ... 29 30
  ggggg: 'YYYYY', // 1970 1971 ... 2029 2030
  // Week Year (ISO)
  GG: 'YY', // 70 71 ... 29 30
  GGGG: 'RRRR', // 1970 1971 ... 2029 2030
  GGGGG: 'RRRRR', //  01970 01971 ... 02029 02030
  // Day of Month
  D: 'd',
  DD: 'dd',
  Do: 'do',
...
export function transform(format) {
