...
const SvgChecklistIncomplete = (props) => {
...
SvgChecklistIncomplete.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgChecklistIncomplete.displayName = 'ChecklistIncomplete';
export default SvgChecklistIncomplete;
