...
const SvgDeviceMobileWarning = (props) => {
...
SvgDeviceMobileWarning.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgDeviceMobileWarning.displayName = 'DeviceMobileWarning';
export default SvgDeviceMobileWarning;
