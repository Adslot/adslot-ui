...
const SvgComplianceShieldRed = (props) => {
...
SvgComplianceShieldRed.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgComplianceShieldRed.displayName = 'ComplianceShieldRed';
export default SvgComplianceShieldRed;
