...
const SvgMediaFormatVideo = (props) => {
  ...
  return (
    ...
    >
      ...
      <g fill="#5d5e5f">
        <path d="M7.8 5.9c-.1-.1-.3-.1-.4-.1-.3 0-.6.2-.6.5v3.4c0 .3.3.6.6.6.1 0 .2 0 .3-.1L10 8.5c.1-.1.2-.3.2-.5s-.1-.4-.2-.5L7.8 5.9zm-.4 3.8V6.4L9.7 8 7.4 9.7z" />
...
SvgMediaFormatVideo.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgMediaFormatVideo.displayName = 'MediaFormatVideo';
export default SvgMediaFormatVideo;
