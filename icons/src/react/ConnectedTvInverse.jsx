...
const SvgConnectedTvInverse = (props) => {
...
SvgConnectedTvInverse.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgConnectedTvInverse.displayName = 'ConnectedTvInverse';
export default SvgConnectedTvInverse;
