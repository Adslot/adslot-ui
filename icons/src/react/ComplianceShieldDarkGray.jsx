...
const SvgComplianceShieldDarkGray = (props) => {
...
SvgComplianceShieldDarkGray.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgComplianceShieldDarkGray.displayName = 'ComplianceShieldDarkGray';
export default SvgComplianceShieldDarkGray;
