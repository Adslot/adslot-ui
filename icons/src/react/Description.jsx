...
SvgDescription.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgDescription.displayName = 'Description';
