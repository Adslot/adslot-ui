...
const SvgComplianceShieldGray = (props) => {
...
SvgComplianceShieldGray.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgComplianceShieldGray.displayName = 'ComplianceShieldGray';
export default SvgComplianceShieldGray;
