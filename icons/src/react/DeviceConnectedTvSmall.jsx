...
const SvgDeviceConnectedTvSmall = (props) => {
...
SvgDeviceConnectedTvSmall.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgDeviceConnectedTvSmall.displayName = 'DeviceConnectedTvSmall';
export default SvgDeviceConnectedTvSmall;
