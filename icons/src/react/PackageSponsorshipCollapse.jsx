...
const SvgPackageSponsorshipCollapse = (props) => {
  ...
  return (
    ...
    >
      ...
      <path d="M44.1 22.7v2.8h-16v-2.8h16z" />
    </svg>
  );
};

SvgPackageSponsorshipCollapse.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgPackageSponsorshipCollapse.displayName = 'PackageSponsorshipCollapse';
export default SvgPackageSponsorshipCollapse;
