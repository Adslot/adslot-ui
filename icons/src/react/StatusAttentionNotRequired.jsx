...
const SvgStatusAttentionNotRequired = (props) => {
...
SvgStatusAttentionNotRequired.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgStatusAttentionNotRequired.displayName = 'StatusAttentionNotRequired';
export default SvgStatusAttentionNotRequired;
