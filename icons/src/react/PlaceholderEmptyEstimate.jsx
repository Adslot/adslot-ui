...
const SvgPlaceholderEmptyEstimate = (props) => {
...
SvgPlaceholderEmptyEstimate.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgPlaceholderEmptyEstimate.displayName = 'PlaceholderEmptyEstimate';
export default SvgPlaceholderEmptyEstimate;
