...
const SvgPlaceholderEmptyInverse = (props) => {
...
SvgPlaceholderEmptyInverse.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgPlaceholderEmptyInverse.displayName = 'PlaceholderEmptyInverse';
export default SvgPlaceholderEmptyInverse;
