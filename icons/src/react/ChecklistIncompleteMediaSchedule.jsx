...
const SvgChecklistIncompleteMediaSchedule = (props) => {
...
SvgChecklistIncompleteMediaSchedule.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgChecklistIncompleteMediaSchedule.displayName = 'ChecklistIncompleteMediaSchedule';
export default SvgChecklistIncompleteMediaSchedule;
