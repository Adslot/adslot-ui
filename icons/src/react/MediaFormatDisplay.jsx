...
const SvgMediaFormatDisplay = (props) => {
...
SvgMediaFormatDisplay.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgMediaFormatDisplay.displayName = 'MediaFormatDisplay';
export default SvgMediaFormatDisplay;
