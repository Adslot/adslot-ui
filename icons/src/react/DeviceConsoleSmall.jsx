...
const SvgDeviceConsoleSmall = (props) => {
...
SvgDeviceConsoleSmall.propTypes = {
  color: PropTypes.string,
  size: PropTypes.number,
  className: PropTypes.string,
};
SvgDeviceConsoleSmall.displayName = 'DeviceConsoleSmall';
export default SvgDeviceConsoleSmall;
